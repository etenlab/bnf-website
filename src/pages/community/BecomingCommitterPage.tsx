        ...
        <>
            ...
            <h2 id='project-independence-and-policies'>
                ...
                <a
                    ...
                    title='Permalink'
                    href='#project-independence-and-policies'
                >
                    ¶
                </a>
            </h2>
            <p>
                ...
                <a href='https://www.apache.org/dev/#mail'>mailing lists</a>, etc., which are{' '}
                <a href='https://blogs.apache.org/comdev/entry/what_makes_apache_projects_different'>
                    documented in various places
                </a>
                .
            </p>
            <p>
                One of these invariant rules is that projects are managed independently of any
                commercial interests. The goal is to create an environment in which all participants
                are equal and thus have an equal opportunity to contribute to and benefit from our
                software, regardless of motivation or financial objectives. This is discussed in
                more detail in our document{' '}
                <a href='/projectIndependence.html'>Project Independence</a>.
            </p>
            <h2 id='communication-on-mailing-lists'>
                Communication on mailing lists{' '}
                <a className='headerlink' title='Permalink' href='#communication-on-mailing-lists'>
                    ¶
                </a>
            </h2>
            <p>
                Development at the ASF has traditionally been done on mailing lists. This is not
                merely because we’ve always done it this way, but is an intentional decision, in
                order to include a wider community than who happens to be on your Slack channel at a
                particular moment.
            </p>
            <p>
                This is why we say, at the ASF,{' '}
                <a href='/contributors/mailing-lists'>
            ...
            <h2 id='moving-from-contributor-to-committer'>
                ...
                <a
                    className='headerlink'
                    title='Permalink'
                    href='#moving-from-contributor-to-committer'
                >
                    ¶
                </a>
            </h2>
            ...
            <p>
                ...
                ensures the project’s vitality, the PMC. In a few projects only a subset of
            ...
            <p>
                One of the key contributions people can make to the community is through the support
                of a wide user base by assisting users on the user list, writing user-oriented docs
                and ensuring the developers understand the user viewpoint. A main idea behind being
                a committer is the ability to be a mentor and to work cooperatively with your peers.
            </p>
            <p>
                Some users of a project’s software become committers in their own right. Some will
                test code, some will write documentation, some will do bug triage and some will
                write code.
            </p>
            <p>
